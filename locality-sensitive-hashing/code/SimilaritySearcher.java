...
/**
 * Searching similar objects. Objects should be represented as a mapping from an
 * object identifier to a set containing the associated values.
 */
public abstract class SimilaritySearcher {
    ...
    /**
     * Returns the pairs of the objectMapping that have a similarity coefficient
     * exceeding threshold
     * 
