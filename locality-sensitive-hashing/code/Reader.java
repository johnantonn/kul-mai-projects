...
public abstract class Reader {
    ...
    /**
     * Partially reset this reader.
     */
    abstract public void partialReset();
    ...
    /**
     * Read a chunk of nDocs documents.
     * 
     * @param nDocs The number of documents to read
     */
    public void readChunks(int nDocs) {
        partialReset();
        int count = 0;
        while (this.hasNext() && count < nDocs) {
            Set<Integer> shingle = this.next();
            this.idToShingle.add(shingle);
            count++;
        }
