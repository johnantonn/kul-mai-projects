...
/**
 * Brute force implementation of the similarity searcher. The Jaccard similarity
 * is computed for all pairs and the pairs that are more similar than a given
