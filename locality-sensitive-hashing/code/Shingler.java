...
/**
 * A SimpleShingler constructs the shingle representations of documents. It
 * takes all substrings of length k of the document, and maps these substrings
 * to an integer value that is inserted into the documents shingle set.
 */
